...
public class VideoJuego3 {
    public static void main(String[] args) {
        ...
        System.out.println("\nSoldados del Ejército 1 en orden de creación:");
    ...
    public static ArrayList<Soldado> crearEjercito(int equipoEjercito, 
        ...
        for (int i = 0; i < numSoldados; i++) {
            ...
            String nombre = "Soldado" + equipoEjercito + "X" + i;
    ...
    // Método àta mostrar el tablero con los soldados creados
        ...
        for (int i = 0; i < filas; i++) {
            ...
            for (int j = 0; j < columnas; j++) {
                ...
                if (soldado == null) {
                    ...
                    // Mostramos los soldados diferenciandolos por ejército
                    if (soldado.getEjercito() == 1) {
                        System.out.print("|SoldaX1");
                    } else {
                        System.out.print("|SoldaX2");
                    }
                }
            }
            System.out.println();
    ...
    public static void determinarGanador(ArrayList<Soldado> ejercito1, ArrayList<Soldado> ejercito2) {
        ...
        if (totalVidaEjercito1 > totalVidaEjercito2) {
            System.out.println("El Ejército 1 gana con " + totalVidaEjercito1 + " puntos de vida");
        } else if (totalVidaEjercito2 > totalVidaEjercito1) {
            System.out.println("El Ejército 2 gana con " + totalVidaEjercito2 + " puntos de vida");
        } else {
